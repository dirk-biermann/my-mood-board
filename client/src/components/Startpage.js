        ...
        <div className="info-box f-row">
          ...
          <div className="f-item f-col txt-box">
            ...
            <div className="b-item desc">
              <p><IconSvg ico="dot" cls="svg-mr svg-sw5 svg-cd50"/>Administration of materials and craft projects.</p>
              <p><IconSvg ico="dot" cls="svg-mr svg-sw5 svg-cd50"/>Visualization with a Mood-Board.</p>
              <p><IconSvg ico="dot" cls="svg-mr svg-sw5 svg-cd50"/>Be creative and more flexible!</p>
            </div>
